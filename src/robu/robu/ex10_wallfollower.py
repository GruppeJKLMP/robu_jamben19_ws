...
class WallFollower(Node):
    ...
    def follow_wall(self):
        ...
        if self.wallfollower_state == WallfollowerStates.WF_STATE_INVALID:
            ...
            #Drehe Roboter solange bis aud der X-Achse der Mindestabstand erscheint
            ...
            if self.front_dist > fd_thresh + self.dist_hysteresis_wf:
                ...
                if turn_direction == 0:
                    ...
                    #safe the current distances as input for state ROTATE2WALL
            ...
            > 0.5)) or ((self.front_dist != np.inf) and (sr == np.inf)):
                msg.angular.z = -self.turning_speed_wf_fast
            else:
    ...
    def scan_callback(self, msg):
        ...
        self.front_dist = msg.ranges[ROBOT_DRIECTION_FRONT_INDEX]
